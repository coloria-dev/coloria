...
resulting expression is always between 0 and 1, and after multiplying by 100, this is
...
\begin{align}\label{eq:e}
  ...
  \frac{%
    ...
    \sqrt{\sum_{i=1}^n \delta_i^2}
  },\quad \alpha = \frac{1}{n} \sum_{i=1}^n \delta_i.\\
  \nonumber
  e_{\text{relSTRESS}}
  &\coloneqq
  100
  \frac{%
    \sqrt{\sum_{i=1}^n \frac{(\tilde{\alpha} - \delta_{i})^2}{\delta_i}}
  }{
    \sqrt{\sum_{i=1}^n \delta_i}
  },\quad \tilde{\alpha} = \left(\frac{1}{n}\sum_{i=1}^n \delta_i^{-1}\right)^{-1}.
\end{align}
